...
/// <summary>
/// Represents a paging/navigation surface for local or remote MAUI data sources.
/// </summary>
public class DataPager : ContentView
{
    /// <summary>
    /// Bindable property for <see cref="PaginationState"/>.
    /// </summary>
    ...
    /// <summary>
    /// Bindable property for <see cref="CurrentRequest"/>.
    /// </summary>
    ...
    /// <summary>
    /// Bindable property for <see cref="PageRequestCommand"/>.
    /// </summary>
    ...
    /// <summary>
    /// Bindable property for <see cref="SortKey"/>.
    /// </summary>
    ...
    /// <summary>
    /// Bindable property for <see cref="SortDescending"/>.
    /// </summary>
    ...
    /// <summary>
    /// Bindable property for <see cref="QueryState"/>.
    /// </summary>
