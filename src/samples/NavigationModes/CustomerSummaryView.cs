...
/// <summary>Provides the summary-contract customer page view.</summary>
public sealed class CustomerSummaryView : ICustomerPageView, IViewFor<CustomerPageViewModel>
{
    /// <inheritdoc />
    public string ViewKind => "summary";
