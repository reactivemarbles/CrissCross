...
/// <summary>Provides the default customer page view.</summary>
public sealed class CustomerPageView : ICustomerPageView, IViewFor<CustomerPageViewModel>
{
    /// <inheritdoc />
    public string ViewKind => "page";
