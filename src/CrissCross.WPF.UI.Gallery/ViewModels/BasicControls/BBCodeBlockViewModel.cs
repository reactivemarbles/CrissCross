...
public partial class BBCodeBlockViewModel : RxObject
{
    ...
    private const string LocalImage = "/CrissCross.WPF.UI.Gallery;component/Assets/ControlImages/RichTextBlock.png";
        ...
        new(
            ...
            [
                ...
                new(
                    ...
                    "[B]Upper-case bold[/B] [I]and italic[/I]"),
            ]);
    ...
    private static BBCodeExampleGroup CreateMediaGroup() =>
        new(
            ...
            [
                ...
                new("Rating", "Rating, maximum, and rate aliases.", "[rate=3.5] [rating=4] [rating=7 max=10]"),]);
