...
namespace CrissCross.MAUI
{
    ...
    /// </summary>
    /// <seealso cref="ReactiveUI.Maui.RoutedViewHost" />
    /// <seealso cref="CrissCross.IViewModelRoutedViewHost" />
    public class ViewModelRoutedViewHost : ReactiveUI.Maui.RoutedViewHost, IViewModelRoutedViewHost
    {
        /// <summary>
        ...
        /// </summary>
        public static readonly BindableProperty HostNameProperty = BindableProperty.Create(
            nameof(HostName),
            typeof(string),
            typeof(ViewModelRoutedViewHost),
            string.Empty);
            ...
            ViewModelRoutedViewHostMixins.ResultNavigating[HostName].DistinctUntilChanged().ObserveOn(RxApp.MainThreadScheduler).Subscribe(e =>
            {
                ...
                if (!e.Cancel)
                {
                    ...
                    if (_navigateBack)
                    {
                        ...
                        {
                            _currentView = ViewLocator.Current.ResolveView(_toViewModel);
            ...
            where T : class, IRxObject
        {
            ...
            _currentView = ViewLocator.Current.ResolveView(_toViewModel, contract);
