...
public sealed class BackButtonVisibilityToVisibilityConverter : IValueConverter
{
    ...
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture) => value is not NavigationViewBackButtonVisible backButtonVisibility
