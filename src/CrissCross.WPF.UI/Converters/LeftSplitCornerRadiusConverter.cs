...
/// <summary>Provides the LeftSplitCornerRadiusConverter member.</summary>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public sealed class LeftSplitCornerRadiusConverter : IValueConverter
{
    ...
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture) => value is not CornerRadius cornerRadius
        ? value
