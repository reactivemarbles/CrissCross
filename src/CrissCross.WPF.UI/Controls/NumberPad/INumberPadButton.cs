...
/// <summary>NumberPad Button.</summary>
public interface INumberPadButton
{
    /// <summary>Occurs when [value changed].</summary>
    event EventHandler<NumberPadValueChangedEventArgs> ValueChanged;
    ...
    /// <summary>Gets or sets a value indicating whether [user changed].</summary>
    ...
    /// <summary>Gets or sets the edited value.</summary>
    /// <value>The value.</value>
    double EditedValue { get; set; }

    /// <summary>Gets or sets a value indicating whether gets or sets the edited value.</summary>
    /// <value>The value.</value>
    bool UseSeperateEditValue { get; set; }

    /// <summary>Gets the value double observable.</summary>
    ...
    /// <summary>Gets the value single observable.</summary>
