...
public class NavigationUserControl : UserControl, ISetNavigation, IUseNavigation, IActivatableView
{
    ...
    /// <summary>Gets or sets a value indicating whether navigating back is enabled.</summary>
    ...
    /// <summary>Gets the navigation host control.</summary>
    ...
    /// <summary>Gets or sets the transition used when switching views.</summary>
    ...
    {
        if (d is not NavigationUserControl nuc || nuc.NavigationFrame is null)
        {
            return;
        }
    ...
    /// <summary>Provides the OnTransitionChanged member.</summary>
    /// <param name="d">The d value.</param>
    /// <param name="e">The event arguments.</param>
    ...
    /// <summary>Provides the EnsureHost member.</summary>
