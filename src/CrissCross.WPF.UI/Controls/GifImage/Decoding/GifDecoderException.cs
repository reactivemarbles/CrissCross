...
public abstract class GifDecoderException : Exception
{
    ...
    {
        var hashCode = 1_144_832_672;
        hashCode = (hashCode * -1_521_134_295) + EqualityComparer<string>.Default.GetHashCode(Message);
        hashCode = (hashCode * -1_521_134_295) + EqualityComparer<IDictionary>.Default.GetHashCode(Data);
        hashCode = (hashCode * -1_521_134_295) + HResult.GetHashCode();
        return hashCode;
    }
}
