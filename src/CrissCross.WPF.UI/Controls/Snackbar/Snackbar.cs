...
public class Snackbar : ContentControl, IAppearanceControl, IIconControl
{
    ...
    public Snackbar(SnackbarPresenter presenter)
    {
        ...
        SetValue(TemplateButtonCommandProperty, ReactiveCommand.Create(Hide));
    }

    /// <summary>Occurs when the snackbar is about to close.</summary>
    ...
    /// <summary>Occurs when the snackbar is about to open.</summary>
    ...
    /// <summary>Gets or sets a time for which the <see cref="Snackbar"/> should be visible.</summary>
    ...
    /// <summary>Gets or sets the title of the <see cref="Snackbar"/>.</summary>
    public object Title
    {
    ...
    /// <summary>Gets or sets the title template of the <see cref="Snackbar"/>.</summary>
    ...
    /// <summary>Gets or sets foreground of the <see cref="ContentControl.Content"/>.</summary>
    [Bindable(true)]
    [Category("Appearance")]
