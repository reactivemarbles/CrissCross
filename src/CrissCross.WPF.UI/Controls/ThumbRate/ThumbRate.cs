...
public class ThumbRate : System.Windows.Controls.Control
{
    ...
    /// <summary>Gets or sets the value determining the current state of the control.</summary>
    ...
    /// <summary>This virtual method is called when <see cref="State" /> is changed.</summary>
