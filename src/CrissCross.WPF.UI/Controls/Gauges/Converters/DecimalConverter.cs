...
public class DecimalConverter : IMultiValueConverter
{
    ...
    /// used.A return value of <see cref="T:System.Windows.DependencyProperty" />.<see
    /// cref="F:System.Windows.DependencyProperty.UnsetValue" /> indicates that the converter did not produce a value,
    ...
    /// />.<see cref="F:System.Windows.Data.Binding.DoNothing" /> indicates that the binding does not transfer the value
    /// or use the <see cref="P:System.Windows.Data.BindingBase.FallbackValue" /> or the default value.
    /// </returns>
