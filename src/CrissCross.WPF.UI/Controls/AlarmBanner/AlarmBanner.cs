...
public class AlarmBanner : System.Windows.Controls.ContentControl
{
    ...
    /// <summary>Gets or sets a value indicating whether the user can close the banner.</summary>
    ...
    /// <summary>Gets or sets the text message displayed by the banner.</summary>
    ...
    /// <summary>Gets or sets the severity for the banner.</summary>
    ...
    /// <summary>Gets or sets the label for the acknowledge button.</summary>
    ...
    /// <summary>Gets or sets a value indicating whether the acknowledge button is visible.</summary>
    ...
    /// <summary>Gets the acknowledge command.</summary>
