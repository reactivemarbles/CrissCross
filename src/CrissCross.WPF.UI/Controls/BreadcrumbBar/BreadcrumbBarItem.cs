...
public class BreadcrumbBarItem : System.Windows.Controls.ContentControl
{
    ...
    /// <summary>Gets or sets the type of the navigation.</summary>
    /// <value>
    ...
    /// <summary>Gets or sets get or sets margin for the <see cref="Icon"/>.</summary>
    ...
    /// <summary>Gets or sets a value indicating whether the current item is the last one.</summary>
    public bool IsLast
    {
