...
/// <summary>Represents PersonPictureAutomationPeer.</summary>
...
public class PersonPictureAutomationPeer(PersonPicture owner) : FrameworkElementAutomationPeer(owner)
{
    ...
    /// <summary>Gets the name of the <see cref="T:System.Windows.UIElement" /> that is associated with this <see
    /// cref="T:System.Windows.Automation.Peers.UIElementAutomationPeer" />. This method is called by <see
    /// cref="M:System.Windows.Automation.Peers.AutomationPeer.GetClassName" />.</summary>
    /// <returns>
