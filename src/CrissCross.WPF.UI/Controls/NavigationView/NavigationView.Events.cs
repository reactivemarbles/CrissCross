...
public partial class NavigationView
{
    ...
    protected virtual void OnPaneOpened() => RaiseEvent(new(PaneOpenedEvent, this));

    /// <summary>Raises the pane closed event.</summary>
    protected virtual void OnPaneClosed() => RaiseEvent(new(PaneClosedEvent, this));

    /// <summary>Raises the selection changed event.</summary>
    protected virtual void OnSelectionChanged() => RaiseEvent(new(SelectionChangedEvent, this));

    /// <summary>Raises the item invoked event.</summary>
    protected virtual void OnItemInvoked() => RaiseEvent(new(ItemInvokedEvent, this));

    /// <summary>Raises the back requested event.</summary>
    protected virtual void OnBackRequested() => RaiseEvent(new(BackRequestedEvent));
