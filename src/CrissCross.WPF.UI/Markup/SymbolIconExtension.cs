...
/// <summary>Custom <see cref="MarkupExtension"/> which can provide <see cref="SymbolIcon"/>.</summary>
/// <example>
/// <code lang="xml">
/// &lt;ui:Button
///     Appearance="Primary"
...
public class SymbolIconExtension : MarkupExtension
{
    ...
    /// <summary>Gets or sets a value indicating whether this <see cref="SymbolIconExtension"/> is filled.</summary>
    /// <value>
