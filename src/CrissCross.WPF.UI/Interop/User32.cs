...
internal static class User32
{
    ...
    /// <summary>EnableMenuItem uEnable values, MF_*</summary>
    [Flags]
    public enum MF : uint
    {
        /// <summary>Possible return value for EnableMenuItem</summary>
    ...
    /// <summary>Menu item element.</summary>
    public enum SC
    {
        SIZE = 0xF000,
        MOVE = 0xF010,
        ...
        /// <summary>SCF_ISSECURE member.</summary>
        F_ISSECURE = 0x00000001,
        ICON = MINIMIZE,
        ZOOM = MAXIMIZE,
    }

    /// <summary>WM_NCHITTEST and MOUSEHOOKSTRUCT Mouse Position Codes</summary>
    public enum WM_NCHITTEST
    {
        /// <summary>Hit test returned error.</summary>
        HTERROR = unchecked(-2),

        /// <summary>Hit test returned transparent.</summary>
    ...
    public enum GWL
    {
        ...
        /// <summary>Sets a new hWnd parent.</summary>
        GWLP_HWNDPARENT = -8,
    ...
    /// <summary>Window composition attributes.</summary>
    public enum WCA
    {
        WCA_UNDEFINED = 0,
    ...
    /// <summary>DWM window accent state.</summary>
    ...
    /// <summary>NativeMonitorInfo member.</summary>
    ...
    /// <summary>NativeRectangle member.</summary>
    ...
    /// <summary>WCA window accent policy.</summary>
    ...
    /// <summary>MSGFLT_*. New in Vista. Realiased in Windows 7.</summary>
    public enum MSGFLT
    {
    ...
    /// <summary>MSGFLTINFO member.</summary>
    ...
    /// <summary>Window message values, WM_*</summary>
    public enum WM
    {
        NULL = 0x0000,
        CREATE = 0x0001,
    ...
    /// <summary>WindowStyle values, WS_*</summary>
    [Flags]
    public enum WS : long
    {
    ...
    /// <summary>Window style extended values, WS_EX_*</summary>
    [Flags]
    ...
    /// <summary>ShowWindow options</summary>
    public enum SW
    {
        HIDE = 0,
        SHOWNORMAL = 1,
    ...
    /// <summary>Gets the monitor information.</summary>
    ...
    /// <summary>
    /// <summary>Provides the UnionRect member.</summary>
    /// </summary>
    ...
    /// <summary>
    /// <summary>Provides the IntersectRect member.</summary>
    /// </summary>
    /// <param name="rc1"></param>
    /// <param name="rc2"></param>
    ...
    /// <summary>
    /// <summary>Provides the GetShellWindow member.</summary>
    /// </summary>
    /// <returns></returns>
    [DefaultDllImportSearchPaths(DllImportSearchPath.System32)]
    [DllImport(Libraries.User32)]
    ...
    /// <summary>
    /// <summary>Provides the MapVirtualKey member.</summary>
    /// </summary>
    ...
    /// <summary>
    /// <summary>Provides the GetSysColor member.</summary>
    /// </summary>
    ...
    /// <summary>
    /// <summary>Provides the GetSystemMenu member.</summary>
    /// </summary>
