...
{
    /// <summary>Casts <see cref="WindowBackdropType"/> to <see cref="Dwmapi.DWMSBT"/>.</summary>
    ...
    /// <summary>Casts <see cref="TaskBarProgressState"/> to <see cref="ShObjIdl.TBPFLAG"/>.</summary>
    ...
    /// <summary>Casts <see cref="ShObjIdl.TBPFLAG"/> to <see cref="TaskBarProgressState"/>.</summary>
