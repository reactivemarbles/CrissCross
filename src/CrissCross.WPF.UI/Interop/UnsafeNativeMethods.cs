...
{
    /// <summary>Tries to set the <see cref="Window"/> corner preference.</summary>
    ...
    /// <summary>Tries to set the corner preference of the selected window.</summary>
    ...
    /// <summary>Tries to remove ImmersiveDarkMode effect from the <see cref="Window"/>.</summary>
    ...
    /// <summary>Tries to remove ImmersiveDarkMode effect from the window handle.</summary>
    ...
    /// <summary>Tries to apply ImmersiveDarkMode effect for the <see cref="Window"/>.</summary>
    /// <param name="window">The window to which the effect is to be applied.</param>
    /// <returns><see langword="true"/> if invocation of native Windows function succeeds.</returns>
    ...
    /// <summary>Tries to apply ImmersiveDarkMode effect for the window handle.</summary>
    /// <param name="handle">Window handle.</param>
    /// <returns><see langword="true"/> if invocation of native Windows function succeeds.</returns>
    ...
    /// <summary>Tries to remove titlebar from selected <see cref="Window"/>.</summary>
    /// <param name="window">The window to which the effect is to be applied.</param>
    /// <returns><see langword="true"/> if invocation of native Windows function succeeds.</returns>
    ...
    /// <summary>Tries to remove titlebar from selected window handle.</summary>
    /// <param name="handle">Window handle.</param>
    /// <returns><see langword="true"/> if invocation of native Windows function succeeds.</returns>
    ...
    /// <summary>Tries to apply selected backdrop type for window handle.</summary>
    /// <param name="handle">Selected window handle.</param>
    ...
    /// <summary>Tries to determine whether the provided <see cref="Window"/> has applied legacy Mica effect.</summary>
    ...
    /// <summary>Tries to determine whether the provided handle has applied legacy Mica effect.</summary>
    /// <param name="handle">Window handle.</param>
    ...
    /// <summary>Tries to apply legacy Mica effect for the selected <see cref="Window"/>.</summary>
    /// <param name="window">The window to which the effect is to be applied.</param>
    /// <returns><see langword="true"/> if invocation of native Windows function succeeds.</returns>
    ...
    /// <summary>Tries to apply legacy Acrylic effect for the selected <see cref="Window"/>.</summary>
    /// <param name="window">The window to which the effect is to be applied.</param>
    /// <returns><see langword="true"/> if invocation of native Windows function succeeds.</returns>
    ...
    /// <summary>Tries to get currently selected Window accent color.</summary>
    ...
    /// <summary>Tries to set taskbar state for the selected window handle.</summary>
    ...
    /// <summary>Tries to set taskbar value for the selected window handle.</summary>
    /// <param name="hWnd">Window handle.</param>
    ...
    /// <summary>Tries to get the pointer to the window handle.</summary>
