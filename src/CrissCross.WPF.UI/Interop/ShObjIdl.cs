...
internal static class ShObjIdl
{
    ...
    /// <summary>THUMBBUTTON member.</summary>
    ...
    /// <summary>Class DECLSPEC_UUID("56FDF344-FD6D-11d0-958A-006097C9A090")</summary>
    [Guid("56FDF344-FD6D-11d0-958A-006097C9A090")]
    [ClassInterface(ClassInterfaceType.None)]
    [ComImport]
    public class CTaskbarList { }

    /// <summary>Class DECLSPEC_UUID("9ac9fbe1-e0a2-4ad6-b4ee-e212013ea917")</summary>
    ...
    {
        /// <summary>Hrs the initialize.</summary>
        [PreserveSig]
        void HrInit();
        ...
        /// <summary>Deletes the tab.</summary>
        /// <param name="hwnd">The HWND.</param>
        [PreserveSig]
        ...
        /// <summary>Sets the active alt.</summary>
        /// <param name="hwnd">The HWND.</param>
        [PreserveSig]
        void SetActiveAlt(IntPtr hwnd);

        /// <summary>Marks the fullscreen window.</summary>
        /// <param name="hwnd">The HWND.</param>
        ...
        /// <summary>Sets the state of the progress.</summary>
        /// <param name="hwnd">The HWND.</param>
        ...
        /// <summary>Unregisters the tab.</summary>
        /// <param name="hwndTab">The HWND tab.</param>
        [PreserveSig]
        void UnregisterTab(IntPtr hwndTab);

        /// <summary>Sets the tab order.</summary>
        /// <param name="hwndTab">The HWND tab.</param>
        /// <param name="hwndInsertBefore">The HWND insert before.</param>
        [PreserveSig]
        void SetTabOrder(IntPtr hwndTab, IntPtr hwndInsertBefore);

        /// <summary>Sets the tab active.</summary>
        /// <param name="hwndTab">The HWND tab.</param>
        /// <param name="hwndInsertBefore">The HWND insert before.</param>
        ...
        /// <summary>Thumbs the bar add buttons.</summary>
        /// <param name="hwnd">The HWND.</param>
        ...
        /// <summary>Sets the overlay icon.</summary>
        /// <param name="hwnd">The HWND.</param>
        ...
        /// <summary>Sets the thumbnail clip.</summary>
        /// <param name="hwnd">The HWND.</param>
        /// <param name="prcClip">The PRC clip.</param>
        [PreserveSig]
        void SetThumbnailClip(IntPtr hwnd, IntPtr prcClip);

        /// <summary>Sets the tab properties.</summary>
