...
/// <summary>The RECT structure defines a rectangle by the coordinates of its upper-left and lower-right
/// corners.</summary>
...
public struct RECT
{
    ...
    /// <summary>Specifies the position of the rectangle.</summary>
