...
public static class ColorExtensions
{
    ...
    public static Color UpdateLuminance(this Color color, float factor)
    {
        ...
        (var hue, var saturation, var rawLuminance) = color.ToHsl();

        (var red, var green, var blue) = FromHslToRgb(hue, saturation, ToPercentage(rawLuminance + factor));
    ...
    public static Color UpdateSaturation(this Color color, float factor)
    {
        ...
        (var hue, var rawSaturation, var brightness) = color.ToHsl();

        (var red, var green, var blue) = FromHslToRgb(hue, ToPercentage(rawSaturation + factor), brightness);
    ...
    public static Color UpdateBrightness(this Color color, float factor)
    {
        ...
        (var hue, var saturation, var rawBrightness) = color.ToHsv();

        (var red, var green, var blue) = FromHsvToRgb(hue, saturation, ToPercentage(rawBrightness + factor));
    ...
    )
    {
        ...
        (var hue, var rawSaturation, var rawBrightness) = color.ToHsv();

        (var red, var green, var blue) = FromHsvToRgb(
            hue,
