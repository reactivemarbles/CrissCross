...
public enum TaskBarProgressState
{
    ...
    /// <summary>A pulsing green (W10) or gray (W11) indicator is displayed in the task bar area.</summary>
    Indeterminate = 0x1,

    /// <summary>A green progress indicator is displayed in the task bar area.</summary>
    Normal = 0x2,

    /// <summary>A red progress indicator is displayed in the task bar area.</summary>
    Error = 0x4,
