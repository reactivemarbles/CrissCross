...
public partial class LiveChart
{
    ...
    private static void RightWidthCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        ...
        livechart.ApplyRightWidth(gridLength);
    }
    ...
    private static void LegendWidthCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        ...
        livechart.ApplyLegendWidth(gridLength);
    }
    ...
    private static void NumberPointsPlottedCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        ...
        livechart.ApplyNumberPointsPlotted(numberOfSamples);
    }

    /// <summary>Handles changes to the Title property by updating the associated LiveChart's ViewModel title.</summary>
    ...
    private static void LegendPositionCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        ...
        livechart.ApplyLegendPosition(position);
    }
    ...
    private static void UseFixedNumberOfPointsCallback(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        ...
        livechart.ApplyUseFixedNumberOfPoints(fixedNumberOfSamples);
    }

    /// <summary>Applies the right panel width.</summary>
    /// <param name="gridLength">The right panel width.</param>
    private void ApplyRightWidth(GridLength gridLength) => RightWidth = gridLength;
    ...
    /// <summary>Applies the legend width.</summary>
    /// <param name="gridLength">The legend width.</param>
    private void ApplyLegendWidth(double gridLength) => RightLegend.Width = gridLength;

    /// <summary>Applies the sample count.</summary>
    /// <param name="sampleCount">The sample count.</param>
    private void ApplySampleCount(int sampleCount) => NSamples = sampleCount;

    /// <summary>Applies the chart frequency.</summary>
    /// <param name="frequency">The chart frequency.</param>
    private void ApplyFrequency(int frequency) => Frequency = frequency;

    /// <summary>Applies the plotted point count.</summary>
    /// <param name="numberOfSamples">The plotted point count.</param>
    private void ApplyNumberPointsPlotted(int numberOfSamples)
    {
        NumberPointsPlotted = numberOfSamples;
        ViewModel?.NumberPointsPlotted = numberOfSamples;
    }

    /// <summary>Applies the chart title.</summary>
    /// <param name="title">The chart title.</param>
    private void ApplyTitle(string title) => ViewModel?.Title = title;
    ...
    private void ApplyUseFixedNumberOfPoints(bool fixedNumberOfSamples)
    {
        UseFixedNumberOfPoints = fixedNumberOfSamples;
        ViewModel?.UseFixedNumberOfPoints = fixedNumberOfSamples;
    }
}
