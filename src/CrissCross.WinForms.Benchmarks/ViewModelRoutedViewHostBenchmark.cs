...
public class ViewModelRoutedViewHostBenchmark : IDisposable
{
    ...
    [Benchmark]
    public void Navigate() => _host?.Navigate(new NavigationKeyRequest<DummyRxObject>());
    ...
    [Benchmark]
    public void NavigateAndReset() => _host?.NavigateAndReset(new NavigationKeyRequest<DummyRxObject>());
