...
/// <summary>
/// Page demonstrating progress controls.
/// </summary>
public partial class ProgressPageView : ReactiveUserControl<ProgressPageViewModel>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ProgressPageView"/> class.
    /// </summary>
    public ProgressPageView()
    {
        ...
        {
            ViewModel ??= AppLocator.Current.GetService<ProgressPageViewModel>();
        });
    }
}
