...
/// <summary>Represents an info bar control for displaying messages.</summary>
public class InfoBar : TemplatedControl
{
    ...
    /// <summary>Property for <see cref="IsIconVisible"/>.</summary>
    ...
    /// <summary>Gets or sets the title of the info bar.</summary>
    public string? Title
    {
    ...
    /// <summary>Gets or sets the message of the info bar.</summary>
    ...
    /// <summary>Gets or sets a value indicating whether the info bar is open.</summary>
    public bool IsOpen
    {
    ...
    /// <summary>Gets or sets a value indicating whether the info bar is closable.</summary>
    ...
    /// <summary>Gets or sets the severity of the info bar.</summary>
    ...
    /// <summary>Gets or sets a value indicating whether the icon is visible.</summary>
    ...
    /// <summary>Closes the info bar.</summary>
    public void Close()
    {
        IsOpen = false;
    }
