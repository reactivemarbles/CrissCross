...
/// <summary>Represents a selection within a <see cref="FlowDocument"/>.</summary>
public sealed class TextSelection
{
    /// <summary>Provides the _document member.</summary>
    private FlowDocument _document;

    /// <summary>Initializes a new instance of the <see cref="TextSelection"/> class.</summary>
    ...
    /// <summary>Gets the start pointer.</summary>
    public TextPointer Start { get; private set; }

    /// <summary>Gets the end pointer.</summary>
    ...
    /// <summary>Gets a value indicating whether the selection is empty.</summary>
    public bool IsEmpty => Length == 0;

    /// <summary>Gets the text contained within the selection.</summary>
    public string Text => _document.GetTextRange(Start, End);

    /// <summary>Replaces the selection with the specified range.</summary>
    ...
    /// <summary>Applies formatting to the current selection.</summary>
    ...
    public void ApplyFormatting(TextFormatType formatType)
    {
        ...
        _ = _document.ToggleFormatting(start, length, formatType);
    }

    /// <summary>Gets the range represented by the selection.</summary>
    /// <returns>A tuple describing the range.</returns>
    public (int start, int length) GetRange() => _document.GetRange(Start, End);

    /// <summary>Updates the selection using absolute offsets.</summary>
    ...
    /// <summary>Rebinds the selection to a new document instance.</summary>
