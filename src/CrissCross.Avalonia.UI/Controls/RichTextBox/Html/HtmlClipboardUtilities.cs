...
internal static class HtmlClipboardUtilities
{
    ...
    /// <summary>Cached Windows HTML Clipboard header format.</summary>
    private static readonly CompositeFormat ClipboardHeaderFormat = CompositeFormat.Parse(
        "Version:1.0\r\nStartHTML:{0:D10}\r\nEndHTML:{1:D10}\r\nStartFragment:{2:D10}\r\nEndFragment:{3:D10}\r\n");

    /// <summary>Provides the ExtractFragment member.</summary>
    /// <param name="html">The html value.</param>
    /// <returns>The result.</returns>
    internal static string ExtractFragment(string html)
    {
    ...
    internal static string CreateClipboardHtml(string fragment)
    {
        ...
        var emptyHeader = string.Format(CultureInfo.InvariantCulture, ClipboardHeaderFormat, 0, 0, 0, 0);
