...
public class ThumbRate : TemplatedControl
{
    ...
    /// <summary>Property for <see cref="SelectedBrush"/>.</summary>
    ...
    /// <summary>Gets or sets the thumb up command.</summary>
    ...
    /// <summary>Gets or sets the thumb down command.</summary>
    ...
    /// <summary>Gets or sets the selected brush.</summary>
    ...
    /// <summary>Gets or sets the unselected brush.</summary>
    ...
    /// <summary>Sets the state to liked.</summary>
    public void ThumbUp()
    {
    ...
    /// <summary>Sets the state to disliked.</summary>
