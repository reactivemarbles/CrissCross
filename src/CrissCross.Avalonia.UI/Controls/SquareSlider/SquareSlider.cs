...
/// <summary>Represents a square-shaped 2D slider control for selecting X/Y values.</summary>
public class SquareSlider : TemplatedControl
{
    /// <summary>Property for <see cref="ValueX"/>.</summary>
    ...
    /// <summary>Property for <see cref="ValueY"/>.</summary>
    ...
    /// <summary>Property for <see cref="MinimumX"/>.</summary>
    ...
    /// <summary>Property for <see cref="MaximumX"/>.</summary>
    ...
    /// <summary>Property for <see cref="MinimumY"/>.</summary>
    ...
    /// <summary>Property for <see cref="MaximumY"/>.</summary>
    ...
    /// <summary>Property for <see cref="ThumbBrush"/>.</summary>
    ...
    /// <summary>Provides the _thumb member.</summary>
    private global::Avalonia.Controls.Border? _thumb;

    /// <summary>Provides the _isDragging member.</summary>
    private bool _isDragging;

    /// <summary>Gets or sets the X value (0.0 to 1.0 by default).</summary>
    ...
    /// <summary>Gets or sets the Y value (0.0 to 1.0 by default).</summary>
    ...
    /// <summary>Gets or sets the thumb size.</summary>
    ...
    /// <summary>Provides the OnCanvasPointerPressed member.</summary>
    ...
    /// <summary>Provides the OnCanvasPointerMoved member.</summary>
    /// <param name="sender">The sender value.</param>
    /// <param name="e">The e value.</param>
    ...
    /// <summary>Provides the OnCanvasPointerReleased member.</summary>
    /// <param name="sender">The sender value.</param>
    /// <param name="e">The e value.</param>
    ...
    /// <summary>Provides the UpdateValueFromPointer member.</summary>
    /// <param name="position">The position value.</param>
    private void UpdateValueFromPointer(Point position)
    {
        if (_canvas is null || _canvas.Bounds.Width == 0 || _canvas.Bounds.Height == 0)
        {
            return;
        }
    ...
    /// <summary>Provides the UpdateThumbPosition member.</summary>
    private void UpdateThumbPosition()
    {
        if (_canvas is null || _thumb is null || _canvas.Bounds.Width == 0 || _canvas.Bounds.Height == 0)
        {
            return;
        }
