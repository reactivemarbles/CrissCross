...
public class TitleBar : global::Avalonia.Controls.Primitives.TemplatedControl
{
    ...
    /// <summary>Gets or sets the buttons background.</summary>
    ...
    /// <summary>Gets or sets a value indicating whether to show maximize button.</summary>
    ...
    /// <summary>Gets or sets a value indicating whether to show minimize button.</summary>
    ...
    /// <summary>Gets or sets a value indicating whether to show close button.</summary>
