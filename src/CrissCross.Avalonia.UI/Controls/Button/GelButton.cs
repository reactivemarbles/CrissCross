...
/// <summary>A button with a gel/glass-like appearance.</summary>
public class GelButton : Button
{
    ...
    public static readonly StyledProperty<Thickness> FocusBorderThicknessProperty =
        AvaloniaProperty.Register<GelButton, Thickness>(nameof(FocusBorderThickness), new(2.0));
    ...
    public static readonly StyledProperty<CornerRadius> OuterCornerRadiusProperty =
        AvaloniaProperty.Register<GelButton, CornerRadius>(nameof(OuterCornerRadius), new(3.0));
    ...
    public static readonly StyledProperty<CornerRadius> InnerCornerRadiusProperty =
        AvaloniaProperty.Register<GelButton, CornerRadius>(nameof(InnerCornerRadius), new(2.0));
