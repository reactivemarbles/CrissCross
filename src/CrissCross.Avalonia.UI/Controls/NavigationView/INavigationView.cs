...
public interface INavigationView
{
    ...
    /// <summary>Gets or sets a value indicating whether the <see cref="Header"/> is visible.</summary>
    bool HeaderVisibility { get; set; }

    /// <summary>Gets or sets whether the header is always visible.</summary>
    ...
    /// <summary>Gets or sets the ContentOverlay value.</summary>
    object? ContentOverlay { get; set; }

    /// <summary>Gets whether the back button is enabled or disabled.</summary>
    bool IsBackEnabled { get; }

    /// <summary>
    /// Gets or sets a value that indicates whether the back button is visible or not.
    /// Default value is "Auto", which indicates that button visibility depends on the DisplayMode setting of the
    /// NavigationView.
    /// </summary>
    NavigationViewBackButtonVisible IsBackButtonVisible { get; set; }

    /// <summary>Gets or sets whether the toggle button is visible.</summary>
    bool IsPaneToggleVisible { get; set; }

    /// <summary>Gets or sets a value indicating whether gets or sets a value that specifies whether the NavigationView
    /// pane is expanded to its full width.</summary>
    bool IsPaneOpen { get; set; }

    /// <summary>Gets or sets whether gets or sets a value that determines whether the pane is shown.</summary>
    ...
    IControlTemplate? ItemTemplate { get; set; }

    /// <summary>Gets or sets the TransitionDuration value.</summary>
    ...
    /// <summary>Gets a value indicating whether gets a value that indicates whether there is at least one entry in back
    ...
    /// <summary>Provides the NavigateWithHierarchy member.</summary>
    /// <param name="pageType">The page type.</param>
    /// <returns>A bool.</returns>
    ...
    /// <summary>Provides the ReplaceContent member.</summary>
    ...
    /// <returns>A bool.</returns>
    bool ReplaceContent(Control pageInstanceToEmbed);

    /// <summary>Provides the ReplaceContent member.</summary>
    /// <param name="pageInstanceToEmbed">The page instance to embed.</param>
    /// <param name="dataContext">The data context.</param>
    /// <returns>A bool.</returns>
    bool ReplaceContent(Control pageInstanceToEmbed, object? dataContext);

    /// <summary>Navigates the NavigationView to the next journal entry.</summary>
    /// <remarks>
    /// Forward journal navigation intentionally has no forward-requested event; only user back-button interactions
    /// raise <see cref="BackRequested"/>.
    /// </remarks>
    ...
    /// <summary>Provides the SetPageService member.</summary>
    /// <param name="pageService">The page service.</param>
    void SetPageService(IPageService pageService);

    /// <summary>Provides the SetServiceProvider member.</summary>
