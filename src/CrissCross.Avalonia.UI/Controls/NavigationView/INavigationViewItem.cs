...
public interface INavigationViewItem
{
    ...
    /// <summary>
    /// Gets a value indicating whether this instance has menu items.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the type of the page to be navigated. (Should be derived from <see cref="Avalonia.Controls.Control"/>).
    /// </summary>
    ...
    /// </summary>
    INavigationViewItem? NavigationViewItemParent { get; set; }
