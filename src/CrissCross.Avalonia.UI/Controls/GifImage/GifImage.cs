...
public class GifImage : global::Avalonia.Controls.Image
{
    ...
    public static readonly StyledProperty<CornerRadius> CornerRadiusProperty =
        AvaloniaProperty.Register<GifImage, CornerRadius>(nameof(CornerRadius), new(0));
    ...
    /// <summary>Property for <see cref="AutoStart"/>.</summary>
    ...
    /// <summary>Property for <see cref="IsAnimating"/>.</summary>
    ...
    /// <summary>Property for <see cref="CurrentFrameIndex"/>.</summary>
    ...
    /// <summary>Gets or sets the CornerRadius.</summary>
    ...
    /// <summary>Gets or sets the source URI for the GIF image.</summary>
    ...
    /// <summary>Gets or sets a value indicating whether to auto-start the animation.</summary>
    ...
    /// <summary>Gets or sets the repeat count for the animation. 0 means infinite.</summary>
    ...
    /// <summary>Gets or sets the animation speed ratio.</summary>
    ...
    /// <summary>Starts the GIF animation.</summary>
    public void StartAnimation() => IsAnimating = true;

    /// <summary>Stops the GIF animation.</summary>
    public void StopAnimation() => IsAnimating = false;

    /// <summary>Pauses the GIF animation.</summary>
    public void PauseAnimation() => StopAnimation();

    /// <summary>Resets the animation to the first frame.</summary>
