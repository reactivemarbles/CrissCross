...
public class FontIcon : IconElement
{
    ...
    /// <summary>Gets or sets the font size used to display text.</summary>
    ...
    /// <summary>Gets or sets the font style to apply to the text content.</summary>
    ...
    /// <summary>Gets or sets the weight of the font used to display the control's text.</summary>
