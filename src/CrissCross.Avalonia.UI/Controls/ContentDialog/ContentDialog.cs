...
public class ContentDialog : ContentControl
{
    ...
    /// <summary>Occurs after the dialog starts to close, but before it is closed.</summary>
    ...
    /// <summary>Occurs after a button is clicked.</summary>
    ...
    /// <summary>Gets or sets the command for the primary button.</summary>
    ...
    /// <summary>Gets or sets the command for the secondary button.</summary>
    ...
    /// <summary>Gets or sets the command for the close button.</summary>
    ...
    /// <summary>Gets or sets the appearance of the primary button.</summary>
    ...
    /// <summary>Gets or sets the appearance of the secondary button.</summary>
    ...
    /// <summary>Gets or sets the appearance of the close button.</summary>
    ...
    /// <summary>Gets or sets the width of the dialog.</summary>
    ...
    /// <summary>Gets or sets the height of the dialog.</summary>
    ...
    /// <summary>Gets or sets the max width of the dialog.</summary>
    ...
    /// <summary>Gets or sets the max height of the dialog.</summary>
    ...
    /// <summary>Gets or sets the margin of the dialog.</summary>
    ...
    /// <summary>Called after the dialog is closed.</summary>
    /// <param name="result">The result.</param>
