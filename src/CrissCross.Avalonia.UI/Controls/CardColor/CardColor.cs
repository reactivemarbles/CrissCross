...
public class CardColor : global::Avalonia.Controls.Primitives.TemplatedControl
{
    ...
    static CardColor()
    {
        _ = SubtitleProperty.Changed.AddClassHandler<CardColor>(static (x, e) => x.OnSubtitlePropertyChanged());
        _ = ColorProperty.Changed.AddClassHandler<CardColor>(static (x, e) => x.OnColorPropertyChanged());
        _ = BrushProperty.Changed.AddClassHandler<CardColor>(static (x, e) => x.OnBrushPropertyChanged());
    }
