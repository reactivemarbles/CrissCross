...
{
    /// <summary>Property for <see cref="CanGoBack"/>.</summary>
    ...
    /// <summary>Property for <see cref="CanGoForward"/>.</summary>
    ...
    /// <summary>Gets or sets a value indicating whether navigation can go back.</summary>
    ...
    /// <summary>Gets or sets a value indicating whether navigation can go forward.</summary>
