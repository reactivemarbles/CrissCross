...
/// <summary>A slider control for adjusting the alpha channel of a color.</summary>
public class AlphaSlider : RangeBase
{
    ...
    /// <summary>Provides the AlphaSlider member.</summary>
    static AlphaSlider()
    {
    ...
    /// <summary>Gets or sets the alpha value (0.0 to 1.0).</summary>
    public double Alpha
    {
