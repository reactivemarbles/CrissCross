...
/// <summary>A control that displays a color preview.</summary>
public class ColorDisplay : TemplatedControl
{
    ...
    /// <summary>Property for <see cref="SecondColor"/>.</summary>
    ...
    /// <summary>Property for <see cref="ShowSecondColor"/>.</summary>
    ...
    public static new readonly StyledProperty<CornerRadius> CornerRadiusProperty =
        AvaloniaProperty.Register<ColorDisplay, CornerRadius>(nameof(CornerRadius), new(4));
    ...
    /// <summary>Gets or sets the secondary color to display.</summary>
    ...
    /// <summary>Gets or sets a value indicating whether to show the second color.</summary>
