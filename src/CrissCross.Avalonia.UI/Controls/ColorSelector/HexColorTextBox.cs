...
public class HexColorTextBox : TextBox
{
    ...
    {
        _ = ColorProperty.Changed.AddClassHandler<HexColorTextBox>(static (x, e) => x.OnColorChanged(e));
        _ = TextProperty.Changed.AddClassHandler<HexColorTextBox>(static (x, e) => x.OnTextChanged(e));
    }
