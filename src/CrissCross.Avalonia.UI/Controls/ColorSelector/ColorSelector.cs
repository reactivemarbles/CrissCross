...
public class ColorSelector : TemplatedControl
{
    ...
    {
        _ = HueProperty.Changed.AddClassHandler<ColorSelector>((x, _) => x.UpdateFromHsv());
        _ = SaturationProperty.Changed.AddClassHandler<ColorSelector>((x, _) => x.UpdateFromHsv());
        _ = BrightnessProperty.Changed.AddClassHandler<ColorSelector>((x, _) => x.UpdateFromHsv());
        _ = AlphaProperty.Changed.AddClassHandler<ColorSelector>((x, _) => x.UpdateFromHsv());
    }
