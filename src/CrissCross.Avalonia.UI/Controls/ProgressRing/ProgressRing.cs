...
public class ProgressRing : TemplatedControl
{
    ...
    static ProgressRing()
    {
        _ = ProgressProperty.Changed.AddClassHandler<ProgressRing>(static (x, e) => x.UpdateProgressAngle());
        _ = IsIndeterminateProperty.Changed.AddClassHandler<ProgressRing>(
            static (x, e) => x.SetCurrentValue(IsActiveProperty, (bool)e.NewValue!));
        _ = IsActiveProperty.Changed.AddClassHandler<ProgressRing>(
            static (x, e) => x.SetCurrentValue(IsIndeterminateProperty, (bool)e.NewValue!));
    }
