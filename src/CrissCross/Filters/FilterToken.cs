...
/// <summary>
/// Represents a removable or fixed filter chip/token used by search and filter controls.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Gets the stable field key represented by the token.
    /// </summary>
    public string Field { get; } = field;

    /// <summary>
    /// Gets the comparison operator represented by the token.
    /// </summary>
    public FilterOperator Operator { get; } = @operator;

    /// <summary>
    /// Gets the field value represented by the token.
    /// </summary>
    public object? Value { get; } = value;

    /// <summary>
    /// Gets the user-facing text shown for the token.
    /// </summary>
    public string DisplayText { get; } = displayText;

    /// <summary>
    /// Gets a value indicating whether the user may remove the token.
    /// </summary>
    public bool IsRemovable { get; } = isRemovable;

    /// <summary>
    /// Gets optional icon content or key used by a platform template.
    /// </summary>
    public object? Icon { get; } = icon;

    /// <summary>
    /// Gets a stable key for equality-aware UI reconciliation.
    /// </summary>
