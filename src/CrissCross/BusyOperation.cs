...
/// <summary>
/// Describes the operation projected by a regional busy overlay.
/// </summary>
/// <remarks>
...
{
    /// <summary>
    /// Gets the operation title displayed by the overlay.
    /// </summary>
    public string Title { get; } = title;

    /// <summary>
    /// Gets optional operation details.
    /// </summary>
    public string? Message { get; } = message;

    /// <summary>
    /// Gets optional normalized progress from 0.0 to 1.0.
    /// </summary>
    public double? Progress { get; } = progress;

    /// <summary>
    /// Gets optional command used to request operation cancellation.
    /// </summary>
    public ICommand? CancelCommand { get; } = cancelCommand;

    /// <summary>
    /// Gets a value indicating whether this operation should be displayed by an overlay.
    /// </summary>
    public bool IsActive => !string.IsNullOrWhiteSpace(Title);

    /// <summary>
    /// Gets a value indicating whether the operation has determinate progress.
    /// </summary>
