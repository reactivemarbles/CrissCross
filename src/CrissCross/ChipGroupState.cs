...
/// <summary>
/// Represents platform-neutral state for a group of chip/tag items.
/// </summary>
public sealed class ChipGroupState
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ChipGroupState"/> class.
    /// </summary>
    ...
    /// <summary>
    /// Gets the chips displayed by the group.
    /// </summary>
    public IReadOnlyList<ChipModel> Chips { get; }

    /// <summary>
    /// Gets the selection mode used by the group.
    /// </summary>
    ...
    /// <summary>
    /// Gets the removable chips.
    /// </summary>
    public IReadOnlyList<ChipModel> RemovableChips { get; }

    /// <summary>
    /// Gets a value indicating whether one or more chips are selected.
    /// </summary>
    public bool HasSelection => SelectedChips.Count > 0;

    /// <summary>
    /// Gets a value indicating whether the group permits multiple selected chips.
    /// </summary>
    public bool CanSelectMultiple => SelectionMode == ChipGroupSelectionMode.Multiple;

    /// <summary>
    /// Gets the chip with the specified key.
    /// </summary>
