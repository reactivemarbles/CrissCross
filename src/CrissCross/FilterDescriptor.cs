...
/// <summary>
/// Describes a field that can participate in descriptor-driven data filtering.
/// </summary>
public sealed class FilterDescriptor
{
    ...
    /// <summary>
    /// Gets the stable field key.
    /// </summary>
    public string Key { get; }

    /// <summary>
    /// Gets the user-facing field name.
    /// </summary>
    ...
    /// <summary>
    /// Gets the supported comparison operators.
    /// </summary>
    public IReadOnlyList<FilterOperator> SupportedOperators { get; }

    /// <summary>
    /// Gets the optional explicit choices for enum-like fields.
    /// </summary>
    ...
    /// <summary>
    /// Gets a value indicating whether the filter requires a value before apply.
    /// </summary>
    public bool IsRequired { get; }

    /// <summary>
    /// Gets the first supported operator used when callers do not specify one.
    /// </summary>
    ...
    /// <summary>
    /// Determines whether the descriptor supports the specified operator.
    /// </summary>
    ...
    /// <summary>
    /// Creates a filter token for this descriptor.
    /// </summary>
    ...
    /// <summary>
    /// Creates display text for a filter value and operator.
    /// </summary>
