...
/// <summary>Immutable status snapshot for controls that present a command execution surface.</summary>
/// <remarks>
...
public sealed class CommandButtonStatus(CommandButtonState state, bool canExecute, bool isExecuting, Exception? error = null)
{
    ...
    /// <summary>Gets a value indicating whether the underlying command can execute.</summary>
    public bool CanExecute { get; } = canExecute;

    /// <summary>Gets a value indicating whether the command is currently executing.</summary>
    public bool IsExecuting { get; } = isExecuting;

    /// <summary>Gets the most recent command error, when the state is failed.</summary>
    public Exception? Error { get; } = error;

    /// <summary>Gets a value indicating whether the command surface should allow user interaction.</summary>
    public bool IsInteractive => CanExecute && !IsExecuting;

    /// <summary>Gets a value indicating whether the state carries a command error.</summary>
    public bool HasError => State == CommandButtonState.Failed && Error is not null;

    /// <summary>Creates an idle status snapshot.</summary>
    /// <param name="canExecute">A value indicating whether the underlying command can execute.</param>
    ...
    /// <summary>Creates an executing status snapshot.</summary>
    /// <param name="canExecute">A value indicating whether the underlying command can execute.</param>
