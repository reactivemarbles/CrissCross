...
/// <summary>
/// Represents an invalid bidirectional navigation registration.
/// </summary>
public sealed class NavigationRegistrationException : InvalidOperationException
{
    /// <summary>
    /// Initializes a new instance of the <see cref="NavigationRegistrationException"/> class.
    /// </summary>
    ...
    /// <summary>
    /// Gets the duplicated source side.
    /// </summary>
    public NavigationSourceKind SourceKind { get; }

    /// <summary>
    /// Gets the duplicated source key.
    /// </summary>
    public Type ServiceType { get; }

    /// <summary>
    /// Gets the duplicated normalized navigation contract.
    /// </summary>
