...
/// <summary>
/// Represents platform-neutral selection state for a segmented control.
/// </summary>
public sealed class SegmentedSelectionState
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SegmentedSelectionState"/> class.
    /// </summary>
    ...
    /// <summary>
    /// Gets the available segments.
    /// </summary>
    public IReadOnlyList<SegmentItem> Items { get; }

    /// <summary>
    /// Gets the selected segment key.
    /// </summary>
    public string? SelectedKey { get; }

    /// <summary>
    /// Gets the enabled segments.
    /// </summary>
    public IReadOnlyList<SegmentItem> EnabledItems { get; }

    /// <summary>
    /// Gets the selected segment, or <c>null</c> when no matching segment is selected.
    /// </summary>
    public SegmentItem? SelectedItem { get; }

    /// <summary>
    /// Gets a value indicating whether a segment is selected.
    /// </summary>
    public bool HasSelection => SelectedItem is not null;

    /// <summary>
    /// Gets the segment with the specified key.
    /// </summary>
