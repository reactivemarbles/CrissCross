...
/// <summary>
/// Groups descriptor-driven property inspector fields by category.
/// </summary>
/// <remarks>
...
public sealed class PropertyDescriptorGroup(string name, IReadOnlyList<PropertyDescriptorModel>? descriptors = null)
{
    ...
    /// <summary>
    /// Gets the descriptors in the category.
    /// </summary>
    public IReadOnlyList<PropertyDescriptorModel> Descriptors { get; } = descriptors ?? [];

    /// <summary>
    /// Gets the number of descriptors in the category.
    /// </summary>
    public int Count => Descriptors.Count;

    /// <summary>
    /// Gets a value indicating whether the category contains invalid descriptors.
    /// </summary>
    public bool HasValidationErrors => Descriptors.Any(static descriptor => descriptor.IsInvalid);

    /// <summary>
    /// Gets a value indicating whether the category contains modified descriptors.
    /// </summary>
