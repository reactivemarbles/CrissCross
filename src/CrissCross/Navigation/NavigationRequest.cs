...
{
    /// <summary>
    /// Gets the source side used to resolve the navigation pair.
    /// </summary>
    public NavigationSourceKind SourceKind { get; } = sourceKind;

    /// <summary>
    /// Gets the optional source instance supplied by the caller.
    /// </summary>
    ...
    /// <summary>
    /// Gets the cancellation token observed before resolution.
    /// </summary>
