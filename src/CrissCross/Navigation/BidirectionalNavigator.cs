...
internal sealed class BidirectionalNavigator : IBidirectionalNavigator
{
    ...
    public BidirectionalNavigator(
        IReadOnlyCollection<NavigationRegistrationDescriptor> registrations,
        IServiceProvider serviceProvider)
    {
        ...
        {
            _viewModelRegistrations.Add(
                new(
                    NavigationSourceKind.ViewModel,
                    descriptor.ViewModelKey,
                    descriptor.Contract),
                descriptor);
            _viewRegistrations.Add(
                new(NavigationSourceKind.View, descriptor.ViewKey, descriptor.Contract),
                descriptor);
        }
    }
