...
/// <summary>
/// Registers bidirectional ViewModel/View navigation pairs.
/// </summary>
public interface INavigationRegistry
{
    /// <summary>
    /// Registers a concrete ViewModel/View pair for bidirectional navigation.
    /// </summary>
    ...
    /// <param name="createViewModel">The AOT-friendly view model factory.</param>
    /// <param name="createView">The AOT-friendly view factory.</param>
    ...
    /// <summary>
    /// Registers a ViewModel/View pair with explicit interface or base-class lookup keys.
    /// </summary>
    /// <typeparam name="TViewModelKey">The caller-facing view model lookup key.</typeparam>
    /// <typeparam name="TViewModel">The concrete view model implementation.</typeparam>
    /// <typeparam name="TViewKey">The caller-facing view lookup key.</typeparam>
    /// <typeparam name="TView">The concrete view implementation.</typeparam>
    /// <param name="createViewModel">The AOT-friendly view model factory.</param>
    /// <param name="createView">The AOT-friendly view factory.</param>
    /// <param name="contract">The optional navigation contract.</param>
    /// <returns>The registry for chained registrations.</returns>
    ...
    /// <summary>
    /// Creates a navigator over the current registrations.
    /// </summary>
    /// <param name="serviceProvider">The optional service provider supplied to registration factories.</param>
