...
| `RichTextBox` | Implemented with class/style and WPF text-box gallery category. | Implemented with class/theme and a larger document/selection helper surface; Avalonia gallery page missing. | Shared text document, selection, clipboard/HTML/Markdown capability contract. | Document parsing/selection tests and gallery sample. | P1 |
